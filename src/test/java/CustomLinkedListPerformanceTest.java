...
public class CustomLinkedListPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("CustomLinkedList_performance.csv")) {
            writer.write("\"Size\";");
            ...
            System.out.println("Performance data written to CustomLinkedList_performance.csv");
        } catch (IOException e) {
